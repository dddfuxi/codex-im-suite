...
export function buildJsonToolFinalResponsePrompt(
  ...
  return [
    ...
    '- Convert successful tool evidence into the most helpful completed answer, not a suggestion for the user to check manually.',
    '- If only part of the request is satisfied, keep the completed part, name the exact blocker, and give the smallest next confirmation needed.',
    '- Do not ask the user to manually inspect, rerun, or verify something that is already visible in the supplied tool history.',
